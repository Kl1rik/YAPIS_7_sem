...
public class MyLanguageParserLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DOCUMENT", "NODE", "ATTRIBUTE", "FUNCTION", "IF", "THEN", "ELSE", "BEGIN", 
			"END", "RETURN", "INT", "STRING", "ASSIGN", "PLUS", "MINUS", "LS", "GT", 
			"DIV", "MULT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMI", "COMMA", 
			"ID", "INT_LIT", "STR_LIT", "WS", "LINE_COMMENT"
		};
	}
	...
	public MyLanguageParserLexer(CharStream input) {
		super(input);
